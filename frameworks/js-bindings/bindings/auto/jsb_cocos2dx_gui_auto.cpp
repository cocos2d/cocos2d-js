...
bool js_cocos2dx_ui_LayoutParameter_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_LayoutParameter_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_LinearLayoutParameter_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_LinearLayoutParameter_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_RelativeLayoutParameter_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_RelativeLayoutParameter_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_Widget_getNodeByTag(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::ui::Widget* cobj = (cocos2d::ui::Widget *)(proxy ? proxy->ptr : NULL);
	JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_ui_Widget_getNodeByTag : Invalid Native Object");
	if (argc == 1) {
		int arg0;
		ok &= jsval_to_int32(cx, argv[0], (int32_t *)&arg0);
		JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_ui_Widget_getNodeByTag : Error processing arguments");
...
bool js_cocos2dx_ui_Widget_getNodes(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::ui::Widget* cobj = (cocos2d::ui::Widget *)(proxy ? proxy->ptr : NULL);
	JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_ui_Widget_getNodes : Invalid Native Object");
	if (argc == 0) {
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Widget_getNodes : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_Widget_updateSizeAndPosition(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Widget_updateSizeAndPosition : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_Widget_removeNodeByTag(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::ui::Widget* cobj = (cocos2d::ui::Widget *)(proxy ? proxy->ptr : NULL);
	JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_ui_Widget_removeNodeByTag : Invalid Native Object");
	if (argc == 1) {
		int arg0;
		ok &= jsval_to_int32(cx, argv[0], (int32_t *)&arg0);
		JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_ui_Widget_removeNodeByTag : Error processing arguments");
		cobj->removeNodeByTag(arg0);
		JS_SET_RVAL(cx, vp, JSVAL_VOID);
		return true;
	}

	JS_ReportError(cx, "js_cocos2dx_ui_Widget_removeNodeByTag : wrong number of arguments: %d, was expecting %d", argc, 1);
	return false;
}
...
bool js_cocos2dx_ui_Widget_getContentSize(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::ui::Widget* cobj = (cocos2d::ui::Widget *)(proxy ? proxy->ptr : NULL);
	JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_ui_Widget_getContentSize : Invalid Native Object");
	if (argc == 0) {
...
bool js_cocos2dx_ui_Widget_addNode(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_ui_Widget_addNode : Invalid Native Object");
	do {
		if (argc == 2) {
			cocos2d::Node* arg0;
			do {
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Widget_addNode : wrong number of arguments");
	return false;
}
...
bool js_cocos2dx_ui_Widget_removeNode(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::ui::Widget* cobj = (cocos2d::ui::Widget *)(proxy ? proxy->ptr : NULL);
	JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_ui_Widget_removeNode : Invalid Native Object");
	if (argc == 1) {
		cocos2d::Node* arg0;
		do {
			if (!argv[0].isObject()) { ok = false; break; }
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Widget_removeNode : wrong number of arguments: %d, was expecting %d", argc, 1);
	return false;
}
bool js_cocos2dx_ui_Widget_removeAllNodes(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::ui::Widget* cobj = (cocos2d::ui::Widget *)(proxy ? proxy->ptr : NULL);
	JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_ui_Widget_removeAllNodes : Invalid Native Object");
	if (argc == 0) {
		cobj->removeAllNodes();
		JS_SET_RVAL(cx, vp, JSVAL_VOID);
		return true;
...
bool js_cocos2dx_ui_Widget_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Widget_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_Layout_hitTest(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::ui::Layout* cobj = (cocos2d::ui::Layout *)(proxy ? proxy->ptr : NULL);
	JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_ui_Layout_hitTest : Invalid Native Object");
	if (argc == 1) {
		cocos2d::Point arg0;
		ok &= jsval_to_ccpoint(cx, argv[0], &arg0);
		JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_ui_Layout_hitTest : Error processing arguments");
		bool ret = cobj->hitTest(arg0);
		jsval jsret = JSVAL_NULL;
		jsret = BOOLEAN_TO_JSVAL(ret);
		JS_SET_RVAL(cx, vp, jsret);
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Layout_hitTest : wrong number of arguments: %d, was expecting %d", argc, 1);
	return false;
}
...
bool js_cocos2dx_ui_Layout_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Layout_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
void js_register_cocos2dx_ui_Layout(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("hitTest", js_cocos2dx_ui_Layout_hitTest, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
bool js_cocos2dx_ui_Button_loadTextures(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Button_loadTextures : wrong number of arguments: %d, was expecting %d", argc, 3);
	return false;
}
...
bool js_cocos2dx_ui_Button_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Button_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
void js_register_cocos2dx_ui_Button(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("loadTextures", js_cocos2dx_ui_Button_loadTextures, 3, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
bool js_cocos2dx_ui_CheckBox_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_CheckBox_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_ImageView_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_ImageView_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_Text_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Text_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_TextAtlas_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_TextAtlas_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_LoadingBar_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_LoadingBar_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_ScrollView_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_ScrollView_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_ListView_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_ListView_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_Slider_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Slider_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_TextField_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_TextField_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_TextBMFont_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_TextBMFont_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_PageView_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JS_ReportError(cx, "js_cocos2dx_ui_PageView_constructor : wrong number of arguments: %d, was expecting %d", argc, 0);
	return false;
}
...
bool js_cocos2dx_ui_Helper_seekWidgetByRelativeName(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	if (argc == 2) {
		...
		std::string arg1_tmp; ok &= jsval_to_std_string(cx, argv[1], &arg1_tmp); arg1 = arg1_tmp.c_str();
		JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_ui_Helper_seekWidgetByRelativeName : Error processing arguments");
	...
	JS_ReportError(cx, "js_cocos2dx_ui_Helper_seekWidgetByRelativeName : wrong number of arguments");
	return false;
}
...
void js_register_cocos2dx_ui_Helper(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec st_funcs[] = {
		...
		JS_FN("seekWidgetByRelativeName", js_cocos2dx_ui_Helper_seekWidgetByRelativeName, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
