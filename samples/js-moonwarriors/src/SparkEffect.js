define(["require", "core", "Sprite", "actions", "game/config/GameConfig", "game/GameLayer"], function(require, cc, Sprite, actions, MW, GameLayer) {
    ...
    var SparkEffect = cc.Class.extend({
        ...
        duration:0.7,
        ctor:function () {
            this.spark1 = new Sprite("#explode2.png");
            this.spark1.setBlendFunc(cc.SRC_ALPHA, cc.ONE);
            this.spark2 = new Sprite("#explode3.png");
        ...
        reset:function (x, y) {
            ...
            var right = actions.rotateBy(this.duration, 45);
            var scaleBy = actions.scaleBy(this.duration, 3, 3);
            var seq = actions.sequence(actions.fadeOut(this.duration), actions.callFunc(this.destroy, this));
