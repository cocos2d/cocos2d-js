...
define([
    ...
    "game/Bullet",
    "game/Explosion"
], function(require, cc, Sprite, actions, audioEngine, spriteFrameCache, Animation, MW, Bullet, Explosion) {
    ...
    var Ship = Sprite.extend({
        ...
        ctor:function () {
            ...
            // set frame
            var frame0 = spriteFrameCache.getSpriteFrame("ship01.png");
            var frame1 = spriteFrameCache.getSpriteFrame("ship02.png");
            ...
            var animate = actions.animate(animation);
        ...
        destroy:function () {
            ...
            if (MW.SOUND) {
                audioEngine.playEffect(res.shipDestroyEffect_mp3);
            }
        },
        hurt:function () {
            if (this.canBeAttack) {
        ...
        initBornSprite:function () {
            this.bornSprite = new Sprite("#ship03.png");
        ...
        born:function () {
            ...
            this.bornSprite.runAction(actions.scaleTo(0.5, 1, 1));
            this.bornSprite.visible = true;
            var blinks = actions.blink(3, 9);
            var makeBeAttack = actions.callFunc(function (t) {
                t.canBeAttack = true;
                t.visible = true;
                t.bornSprite.visible = false;
            }.bind(this));
            this.runAction(actions.sequence(actions.delayTime(0.5), blinks, makeBeAttack));
