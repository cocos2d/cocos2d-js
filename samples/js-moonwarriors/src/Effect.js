define(["require", "core", "Sprite", "actions", "cocos2d/actions/CCActionEase"], function(require, cc, Sprite, actions, eases) {
    ...
    var flareEffect = function (flare, target, callback) {
        ...
        var biggerEase = cc.scaleBy(0.7, 1.2, 1.2).easing(eases.easeSineOut());
        var easeMove = cc.moveBy(0.5, cc.p(328, 0)).easing(eases.easeSineOut());
        var rotateEase = cc.rotateBy(2.5, 90).easing(eases.easeExponentialOut());
    ...
    var spark = function (x, y, parent, scale, duration) {
        ...
        var one = new Sprite("#explode1.png");
        var two = new Sprite("#explode2.png");
        var three = new Sprite("#explode3.png");
