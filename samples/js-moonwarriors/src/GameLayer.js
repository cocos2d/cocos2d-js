...
define([
    ...
    "game/BackTileMap",
    "game/GameOver"
], function(cc, Scene, ls,
            Sprite, spriteFrameCache, SpriteBatchNode,
            LabelTTF, LabelBMFont, actions, audioEngine,
            MW,
            LevelManager,
            Ship,
            Explosion,
    ...
    var GameLayer = ls.Layer.extend({
        ...
        init:function () {
            spriteFrameCache.addSpriteFrames(res.textureOpaquePack_plist);
            spriteFrameCache.addSpriteFrames(res.b01_plist);
            ...
            this._texOpaqueBatch = new SpriteBatchNode(texOpaque);
            ...
            this._texTransparentBatch = new SpriteBatchNode(texTransparent);
            ...
            // score
            this.lbScore = new LabelBMFont("Score: 0", res.arial_14_fnt);
            this.lbScore.attr({
                anchorX: 1,
                anchorY: 0,
                x: winSize.width - 5,
            ...
            // ship life
            var life = new Sprite("#ship01.png");
            life.attr({
                scale: 0.6,
                x: 30,
                y: 460
            ...
            // ship Life count
            this._lbLife = new LabelTTF("0", "Arial", 20);
            this._lbLife.x = 60;
            this._lbLife.y = 463;
            ...
            spriteFrameCache.addSpriteFrames(res.explosion_plist);
            var explosionTexture = cc.textureCache.addImage(res.explosion_png);
            this._explosions = new SpriteBatchNode(explosionTexture);
           ...
           if (cc.sys.capabilities.hasOwnProperty('keyboard'))
            ...
            if (MW.SOUND)
                audioEngine.playMusic(res.bgMusic_mp3, true);
        ...
        checkIsReborn:function () {
            ...
            if (MW.LIFE > 0 && !locShip.active) {
                ...
                this.runAction(actions.sequence(
                    actions.delayTime(0.2),
                    actions.callFunc(this.onGameOver, this)
                ));
            }
        },
        updateUI:function () {
        ...
        moveTileMap:function () {
            ...
            var move = actions.moveBy(ran * 2 + 10, cc.p(0, -winSize.height-240));
            var fun = actions.callFunc(function(){
                backTileMap.destroy();
            },this);
            backTileMap.runAction(actions.sequence(move,fun));
        },
    ...
    GameLayer.sharedGameLayer = null;
